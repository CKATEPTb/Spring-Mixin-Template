package dev.ckateptb.webmorph.mixin.security.rsocket;
 ...
 * <p>
 * Implements the {@link dev.ckateptb.webmorph.configuration.security.api.AuthHolder} interface
 * to associate a deferred {@link org.springframework.security.core.Authentication} instance
 ...
 * <p>
 * The authentication is injected externally via {@link #setAuth(java.util.function.Supplier)},
 * and retrieved reactively via {@link #getAuth()}.
 * <p>
 * Actual resolution and conversion of bearer tokens into {@code Authentication}
 * is implemented in
 * {@link dev.ckateptb.webmorph.configuration.security.bearer.PayloadExchangeBearerConverter},
