...
public class GetMetadataController {
    ...
    @MessageMapping("account.get-metadata")
    public Mono<GetMetadataResponse> getMetadata(@AuthenticationPrincipal Account account, @Payload @Validated GetMetadataRequest request) {
     ...
     */
    public record GetMetadataResponse(@Nullable String value) {
    }
}
