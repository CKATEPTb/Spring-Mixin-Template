package dev.ckateptb.webmorph.eventbus;
 ...
 *
 * <p>Supports both manually registered handlers via {@link #on(Class, EventPriority, boolean, dev.ckateptb.webmorph.eventbus.event.EventHandler)}
...
public class EventBus {
     ...
     */
    public <E extends Event> Disposable on(Class<E> eventClass, EventPriority priority, boolean ignoreCancelled, dev.ckateptb.webmorph.eventbus.event.EventHandler<E> handler) {
     ...
     */
    public <E extends Event> Disposable on(Class<E> eventClass, boolean ignoreCancelled, dev.ckateptb.webmorph.eventbus.event.EventHandler<E> handler) {
     ...
     * @return a {@link Disposable} to unsubscribe the handler
     */
    public <E extends Event> Disposable on(Class<E> eventClass, EventPriority priority, dev.ckateptb.webmorph.eventbus.event.EventHandler<E> handler) {
     ...
     * @return a {@link Disposable} to unsubscribe the handler
     */
    public <E extends Event> Disposable on(Class<E> eventClass, dev.ckateptb.webmorph.eventbus.event.EventHandler<E> handler) {
                            ...
                            Arrays.stream(parameters)
                                    ...
                                    .ifPresent(type -> {
                                        if (Event.class.isAssignableFrom(type)) {
                                            EventHandler handler = method.annotation(annotation);
